...
class _HomeState extends State<Home> {
  ...
  List <CatalogItem> catalogItems = [
    ...
    CatalogItem(nameItem:'Cap', priceItem:'12.00', imageItem:'image_cap.png', descriptionItem:'This is Cap')
  ...
  Widget build(BuildContext context) {
    ...
    actions:<Widget> [ 
      Padding(
        ...
        child: IconButton(icon: Icon(Icons.shopping_basket), onPressed: (){setState(() {
          item = 0;
        });},)
    ),
      )],
...
body: Column(children: catalogItems.map((catalogItem) => catalogItemCard(catalogItem)).toList(),),
    ...
    //         label: Text('restore item', style: TextStyle(color: Colors.white, fontSize: 20.0)
    //         ),
